...
const ALL_VARIABLES: { key: string; desc: string }[] = [
    ...
    { key: 'old_email', desc: 'Email cũ' },
    { key: 'new_email', desc: 'Email mới' },
    { key: 'confirmation_url', desc: 'Link xác nhận đổi email' },
    { key: 'token', desc: 'Mã Code xác thực cũ' },
    { key: 'new_token', desc: 'Mã Code xác thực mới' },
    // Leave
