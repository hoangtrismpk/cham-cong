                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                {employee.status === 'active' ? (
                                                    <div className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-500/10 text-green-400 border border-green-500/20 shadow-[0_0_10px_rgba(34,197,94,0.1)]">
                                                        ...
                                                        {t.admin.employeeManagement.table.active || 'Hoạt động'}
                                                    </div>
                                                ) : (
                                                    <div className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-500/10 text-red-400 border border-red-500/20 shadow-[0_0_10px_rgba(239,68,68,0.1)]">
                                                        <div className="w-1.5 h-1.5 bg-red-500 rounded-full mr-1.5"></div>
                                                        {t.admin.employeeManagement.table.inactive || 'Đã nghỉ việc'}
                                                    </div>
                                                )}
                                            </td>
