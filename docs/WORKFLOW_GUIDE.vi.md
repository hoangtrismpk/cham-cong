...
### `/log-error` - Ghi nhận lỗi
- **Khi nào dùng**: Ghi lại lỗi vào Error Log để học tập và cải thiện.
- **Cách dùng**: `/log-error`
...
### `/preview` - Xem trước web 
- **Khi nào dùng**: Muốn xem trước web chạy thế nào? Bật Preview.
- **Cách dùng**: `/preview`
...
### `/update-docs` - Tự động cập nhật tài liệu
- **Khi nào dùng**: Tự động cập nhật tài liệu khi có tính năng mới.
- **Cách dùng**: `/update-docs`

### `/update` - Cập nhật Antigravity
- **Khi nào dùng**: Kiểm tra và cập nhật phiên bản Antigravity IDE.
- **Cách dùng**: `/update`
